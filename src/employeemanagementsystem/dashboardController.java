...
public class dashboardController implements Initializable {
    ...
    public void homeEmployeeTotalPresent() {
        ...
        String sql = "SELECT COUNT(employee_id) FROM employee_info where salary != 0";
    ...
    private String[] positionList = {"Market Coordinator", "Web Developer (Back End)", "Web Developer (Front End)", "App Developer","Manager","Full Stack Developer"};
